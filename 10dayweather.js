...
function logDay(obj)
{
    ...
    li1.innerHTML = li1.innerHTML + 'High: <font size="3">' + obj.high.fahrenheit + '\u00B0' + ' F</font>' + '<br>' + 'Low: <font size="3">' + obj.low.fahrenheit + '\u00B0' + ' F</font>' + '<br>';
